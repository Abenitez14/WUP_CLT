...
In this graph there is only one peak, the mean is `r mean(my1000$k9) ` , the sd is `r sd(my1000$k9)`
...
There is also only one peak in this graph, the mean is `r mean(my1000$k16)`, the sd is `r sd(my1000$k16)`.
...
From this pattern all of the graphs are only going to have one peak, the mean is `r mean(my1000$k25)`,the sd is `r sd(my1000$k25)`.
...
From this pattern all of the graphs are only going to have one peak,as i said the last one only had one peak, the mean is `r mean(my1000$k36)`,the sd is `r sd(my1000$k36)`.

# Conclusion

From the look of all the samples the mean stayed basically the same the only ones that actually changed was the sd, the bigger sample the more the sd will reduce you divide the original with the square root of the sample taking out and you will get the new sd.
